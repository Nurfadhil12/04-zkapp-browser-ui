...
// Status
  ...
  return (
	<div className={styles.container}>	
	  <Head>
        <title>zkApp [Fadhil]</title>
        <meta name="description" content="ZkApp By Fadhil" />
		...
		<main className={styles.main}>
			...
			<div id="homepage" className={styles.homepage}>
				...
				<a id="connectBtn" style={{display: 'block'}} onClick={() => {connectBtnclick(); connectWallet();}}>
					...
					<span id="banner" style={{display: 'block'}} className={styles.banner}> haha </span>
			...
			<div id="footer" style={{display: 'block'}} >	
				...
				<a style={{display: 'block'}} href="https://t.me/Nurfadhil12" target="_blank" rel="noopener noreferrer" >
						<span className={styles.teleIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://discordapp.com/users/bang brewok12#2518" target="_blank" rel="noopener noreferrer" >
						<span className={styles.dcIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://github.com/Nurfadhil12" target="_blank" rel="noopener noreferrer" >
						<span className={styles.gitIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://web.facebook.com/bang.fadhil.1257" target="_blank" rel="noopener noreferrer" >
